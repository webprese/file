...
class pageflipAlbumImage
{
	...
	function asXML()
	{
		return '<img id="' . $this->id . '" thumb="' . htmlspecialchars($this->thumb) . '" width="' . $this->width . '" height="' . $this->height . '" />' . "\n";
	}
}
...
class pageflipAlbumImg
{
	...
	function asXML()
	{
		return '<img id="' . $this->id . '" scaling="' . $this->scaling . '" x="' . $this->x . '" y="' . $this->y . '" description="' . htmlspecialchars($this->description) . '" />' . "\n";
	}
}
